...
const BusinessInfoValidationSchema = yup.object().shape({
  ...
  districtState: yup.string().required("District / State is required"),
  cityTown: yup.string().required("City / Town is required"),
  postcodeZipcode: yup.string().required("Postcode / Zipcode is required"),
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-between gap-4 mt-6 w-full">
            <Button
              ...
              onClick={onBack}
              variant="outlined"
              disabled={true} // Disable back button on first step
